...
CREATE TABLE books (
    ...
    year INT NOT NULL,
    genre VARCHAR(80) DEFAULT 'Uncategorised',
    created_by INT NULL,
...
INSERT IGNORE INTO users (name, email, password_hash, role) VALUES
 ('Demo Admin', 'admin@books.test', '$2y$10$XUO0pjTrUJMJBzxD5fn5ROOzooHxhmyRsgPFPeI5Mu9TsbuPCt5Du', 'admin'),
 ('Demo Member', 'member@books.test', '$2y$10$XUO0pjTrUJMJBzxD5fn5ROOzooHxhmyRsgPFPeI5Mu9TsbuPCt5Du', 'member');

 USE books_api;


-- Assign initial owners for existing records
